            ...
            public void done(List<ParseObject> userList, ParseException e) {
                if (e == null) {
                    ...
                    for (int i = 0; i < userList.size(); i++) {
                        ...
                        names.add(userList.get(i).get("FriendsUsername").toString());
                    }
                    ...
                    receiver = new BroadcastReceiver() {
                        ...
                        public void onReceive(Context context, Intent intent) {
                            ...
                            if (!success) {
                                ...
                                Toast.makeText(getApplicationContext(), "Messaging service has started successfully!!", Toast.LENGTH_LONG).show();
                            }
                        }
                    };
