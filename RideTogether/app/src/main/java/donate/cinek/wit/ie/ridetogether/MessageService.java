...
public class MessageService extends Service implements SinchClientListener {
    ...
    private static final String APP_SECRET = "+tyrlzz28EmIBVWYZrPr0Q==";
    ...
    private Intent broadcastIntent = new Intent("donate.cinek.wit.ie.ridetogether.ListUsersActivity");
